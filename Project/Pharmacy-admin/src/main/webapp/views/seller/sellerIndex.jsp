        ...
        <div class="row">
          ...
          <div class="col-md-3 my-1">
            <a href="/medicineInventory" class="btn btn-success btn-block">
               Medicine list available Medi Box
            </a>
          </div>
          <div class="col-md-3 my-1">
            <a
              href="/sellerMedicineManager"
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>pending</td>
                    <td>
                      <a href="orderpage.html" class="btn btn-secondary">
          ...
          <div class="col-md-3">
            <div class="card text-center bg-success text-white mb-3">
              <div class="card-body">
                ...
                <a href="./orderpage.html" class="btn btn-outline-light btn-sm"
                  >View</a
                >
              </div>
            </div>
