...
<body>
	...
	<section id="actions" class="py-4 mb-4 bg-light">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<a href="/collapseADDMedicineData" class="btn btn-primary btn-block"> <i class="fas fa-plus"></i>
						ADD Medicine Data
					</a>
				</div>
				<div class="col-md-3">
					<a href="/medicinemaster" class="btn btn-success btn-block"> <i class="fas fa-plus"></i> Medicine
						inventery
					</a>
				</div>
				<div class="col-md-3">
							...
							<tbody>
								<c:forEach var="item" items="${pendingSeller}">
									<tr>
										...
										<td>
											<c:if test="${item.status == 0}">On Hold</c:if>
											<c:if test="${item.status == 1}">Active</c:if>
										</td>
										<td><a href="/sellerDetailsFind?sid=${item.sellerId}" class="btn btn-secondary">
