		...
		<div class="dark-overlay">
			<div class="home-inner container">
				<div class="row">
					<div class="col-lg-4 d-none d-lg-block">
						<div class="d-flex">
							<div class="p-4 align-self-start">
								<a href="/"><img src="./image/logo1.png" alt="@logo" height="auto" width="200px"
										class="logosignup" /></a>
							</div>
						</div>
					...
					<c:if test="${userexist}">
						<div class="w-50  m-auto alert alert-danger text-center alert-dismissible fade show"
							role="alert">
								...
								<form method="post" action="process_userSignup">
									<div class="form-group">
										<input type="text" class="form-control form-control-lg" id="fullName"
											...
											required="required" /> <span id="fullname-error" class="text-danger"></span>
									</div>
									<div class="form-group">
